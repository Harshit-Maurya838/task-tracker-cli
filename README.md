...
This is a command-line interface (CLI) application for managing tasks. We can add, update, delete, mark, and list tasks directly from the terminal.
...
1. **Clone the repository:**
   ...
   ```bash
        git clone https://github.com/Harshit-Maurya838/task-tracker-cli.git
        cd task-tracker-cli
    ```
