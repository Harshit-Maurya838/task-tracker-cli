public class TaskCLIApp {
    public static void main(String[] args) {
        ...
        if(args.length < 1){
            System.out.println("Usage: java TaskCLIApp <command> [arguments]");
            return;
        }
        ...
        switch (command) {
            case "add":
                if(args.length < 2){
                    System.out.println("Usage: java TaskCLIApp add <description>");
                    return;
                }
            ...
            case "update":
                if(args.length < 3){
                    System.out.println("Usage: java TaskCLIApp update <id> <new description>");
                    return;
                }
            ...
            case "delete":
                if(args.length < 2){
                    System.out.println("Usage: java TaskCLIApp delete <id>");
                    return;
                }
            ...
            case "mark-in-progress":
                if(args.length < 2){
                    System.out.println("Usage: java TaskCLIApp mark-in-progress <id>");
                    return;
                }
